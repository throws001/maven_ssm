...
public class QiNiuUtils {
    ...
    private static final String ACCESSKEY = "L6nscAjMZpb1ep3P2xMWmhjElt363aPSzKiK4fpN";
    private static final String SECRETKEY = "KPegWMneDQ7h3XMBySzNJsnz70LQiBPfTHf0CYcI";
    // 对象仓库
    private static final String BUCKET = "sz118";
    public static final String DOMAIN= "http://qzmq2cz5v.hn-bkt.clouddn.com/";
